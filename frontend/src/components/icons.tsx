...
/**
 * Inline stroke icons. Kept local rather than pulled from a package so the bundle has no
 * icon dependency and every glyph inherits currentColor.
 */
...
export const IconDumbbell = (p: IconProps) => (
  <Svg {...p}><path d="M6.5 6.5v11M3 9v5M17.5 6.5v11M21 9v5M6.5 12h11" /></Svg>
);
...
export const IconCrown = (p: IconProps) => (
  <Svg {...p}><path d="M3 7l4 4 5-6 5 6 4-4v11H3z" /></Svg>
);
...
export const IconChart = (p: IconProps) => (
  <Svg {...p}><path d="M3 3v18h18" /><rect x="7" y="12" width="3" height="6" /><rect x="12" y="8" width="3" height="10" /><rect x="17" y="4" width="3" height="14" /></Svg>
);
...
export const IconFilter = (p: IconProps) => (
  <Svg {...p}><path d="M22 3H2l8 9.5V19l4 2v-8.5z" /></Svg>
);
...
export const IconBox = (p: IconProps) => (
  <Svg {...p}><path d="M21 16V8l-9-5-9 5v8l9 5z" /><path d="M3.3 7L12 12l8.7-5M12 22V12" /></Svg>
);
export const IconQr = (p: IconProps) => (
  <Svg {...p}><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /><path d="M14 14h3v3h-3zM19 19h2v2h-2z" /></Svg>
);
